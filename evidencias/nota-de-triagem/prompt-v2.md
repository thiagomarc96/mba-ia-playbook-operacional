...
Antes de responder, confira: cada campo precisa estar completo. Em AÇÃO IMEDIATA, escreva a ação concreta recomendada, nunca somente "recomendar". Mantenha o significado das medidas: rejeição de 6% é 6% dos eventos, não 6% de tenants. Não acrescente "acima de" a um valor exato. Em ESCALAR PARA, escreva somente o handle e "se persistir" quando o alerta não informar prazo. Os prazos e ações dos exemplos não se aplicam ao alerta novo.
