...
Não prometa garantir SLA, orçamento ou perda zero com os dados disponíveis. Retenção maior evita expiração, mas não reduz lag e não prova o SLA do Forge. Prioridade só ajuda o Sentinel se houver capacidade suficiente reservada para sua carga. Calcule backlog = (pico - capacidade) × duração. Expresse drenagem como backlog/(capacidade - taxa posterior), somente quando a diferença for positiva; como a taxa posterior não foi informada, não invente uma margem. Se ilustrar um limite inferior com entrada zero, rotule essa hipótese. Compare a ordem de grandeza do backlog com os SLAs. Encerre com condições mensuráveis para validar a proposta, não com garantia. Não fixe retenção nova nem custos sem dados de tamanho por mensagem e armazenamento.
